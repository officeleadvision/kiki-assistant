						...
						{:else if valvesSpec.properties[property]?.input ?? null}
							{#if valvesSpec.properties[property]?.input?.type === 'color'}
								<div class="flex items-center space-x-2">
									...
									<input
										type="text"
										class="flex-1 rounded-lg py-2 text-sm dark:text-gray-500 dark:bg-gray-850 outline-hidden border border-gray-100/30 dark:border-gray-850/30"
							...
							{:else if valvesSpec.properties[property]?.input?.type === 'map'}
								...
								<div class="flex flex-col items-center gap-1">
									...
									{#if valves[property]}
										<input
											type="text"
											class=" w-full rounded-lg py-1 text-left text-sm dark:text-gray-500 dark:bg-gray-850 outline-hidden border border-gray-100/30 dark:border-gray-850/30"
