										...
										<div class="flex mt-0.5 mb-0.5 space-x-2">
											<div class=" flex-1">
												{#if variables[variable]?.type === 'select'}
													...
													<select
														class="w-full rounded-lg py-2 px-4 text-sm dark:text-gray-500 dark:bg-gray-850 outline-hidden border border-gray-100/30 dark:border-gray-850/30"
												...
												{:else if variables[variable]?.type === 'checkbox'}
													<div class="flex items-center space-x-2">
														...
														<input
															type="text"
															class="flex-1 py-1 text-sm dark:text-gray-500 bg-transparent outline-hidden"
												...
												{:else if variables[variable]?.type === 'color'}
													<div class="flex items-center space-x-2">
														...
														<input
															type="text"
															class="flex-1 py-2 text-sm dark:text-gray-500 bg-transparent outline-hidden"
													...
													<div class="flex items-center space-x-2">
														<div class="relative flex justify-center items-center gap-2 flex-1">
															<input
																type="range"
																bind:value={variableValues[variable]}
																class="w-full rounded-lg py-1 px-4 text-sm dark:text-gray-500 dark:bg-gray-850 outline-hidden border border-gray-100/30 dark:border-gray-850/30"
																id="input-variable-{idx}"
																{...variableAttributes}
															/>
														</div>
														...
														<input
															type="text"
															class=" py-1 text-sm dark:text-gray-500 bg-transparent outline-hidden text-right"
												...
												{:else if variables[variable]?.type === 'map'}
													...
													<div class="flex flex-col items-center gap-1">
														...
														<input
															type="text"
															class=" w-full py-1 text-left text-sm dark:text-gray-500 bg-transparent outline-hidden"
