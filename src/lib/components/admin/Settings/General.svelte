					...
					{#if adminConfig?.ENABLE_API_KEYS}
						...
						{#if adminConfig?.ENABLE_API_KEYS_ENDPOINT_RESTRICTIONS}
							<div class=" flex w-full flex-col pr-2 mb-2.5">
								...
								<input
									class="w-full mt-1 text-sm dark:text-gray-500 bg-transparent outline-hidden"
									type="text"
								...
								<div class="mt-2 text-xs text-gray-400 dark:text-gray-500">
									<!-- https://docs.Lead Me.com/getting-started/advanced-topics/api-endpoints -->
									<a
										href="https://docs.Lead Me.com/getting-started/api-endpoints"
										target="_blank"
							...
							<div class="mt-2 text-xs">
								...
								>
									<div>
										...
										<span
											><a
												href="https://docs.Lead Me.com/getting-started/env-configuration#jwt_expires_in"
												target="_blank"
												class=" underline"
